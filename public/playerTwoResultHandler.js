    ...
    if (button) {
      button.addEventListener('click', function() {
        ...
        if (user.uid === playerOne.uid) {
          ...
          playerOneScores = [];
          console.log('User One reset playerOneScores:', playerOneScores);
          
          // Reset currentScore
          playerOneCurrentScore = 0;
          console.log('User One reset playerOneCurrentScore:', playerOneCurrentScore);
          
          // Reset lastScore
          playerOneLastScore = 0;
          console.log('User One reset playerOneLastScore:', playerOneLastScore);
...
function handleAnswerSubmission(question, selectedAnswer, questionDiv) {
    ...
    if (user.uid === playerOne.uid && lastUserToClick === playerOne.uid) {
